...
class GroupedStampsView(TitleBreadcrumbsMixin, ListView):
    ...
    def get_queryset(self):
        self.stamp_group = get_object_or_404(StampGroup,
...
class StampDetailView(TitleBreadcrumbsMixin, DetailView):
    ...
    def crumbs(self):
        """Breadcrumbs."""
        current_stamp_group = get_object_or_404(StampGroup,
                                                slug=self.kwargs['group'])
        return [(current_stamp_group.title,
                 reverse_lazy('mainapp:stamps',
